...
public class MoreRedocGui extends JFrame {
	...
	private void runGenerateModel() {
		JOptionPane.showConfirmDialog(this, "asdasd");

		this.buttonGenerateModels.setEnabled(false);
		backgroundWorker = new SwingWorker<Void, Void>() {
			@Override
			protected Void doInBackground() throws Exception {
				logger.info("Start model generation");
				setUiActive(false);
				MoreRedocLogicStarter.runMoreRedocLogic(textfieldCsvKeywords.getText(), textfieldCsvText.getText(),
						textfieldOutputFolder.getText());
	...
	private void setUiActive(boolean activeState) {
		...
		this.textfieldCsvKeywords.setEnabled(activeState);
		this.textfieldCsvText.setEnabled(activeState);
		this.textfieldOutputFolder.setEnabled(activeState);
